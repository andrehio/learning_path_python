# Função (Exercício de fixação 4)
# Curso: Raciocínio Lógico
# Pontifícia Universidade Católica do Paraná (PUC-PR)
'''
Exercício de fixação 4: Crie um programa que, fazendo uso de funções, cadastre contatos em
uma agenda telefônica, podendo exclui-los. Deve ser exibido um menu com as opções: inserir,
remover e sair.
'''
